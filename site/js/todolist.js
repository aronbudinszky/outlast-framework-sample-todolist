 ...
 * @note Yes, this is not optimal (you wouldn't want to refresh the whole list after this). But this is a quick demo. :)
 */
function addItem(){
	...
	// Now, let's set the input to empty
...
function removeItem(itemid){
	// This will submit the data and run the second parameter callback function with the returned ajax
		zaj.ajax.get('/todo/remove/?id='+zaj.urlencode(itemid), function(r){
			// If ok is returned, refresh. Otherwise alert.
				if(r == 'ok') refreshItems();
				else zaj.alert(r);
		});
